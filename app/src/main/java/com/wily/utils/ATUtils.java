...
import com.wily.DeviceAdminActivity;
import com.wily.R;
import com.wily.ScreenShotActivity;
import com.wily.Transparent;
...
public class ATUtils {
	...
	public void takeScreenShot() {
		...
		try {
			context.startActivity(new Intent(context, Transparent.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
