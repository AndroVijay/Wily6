...
import com.wily.AppsListActivity;
import com.wily.R;
import com.wily.adapters.ATItemsGridAdapter;
...
import static com.wily.AppsListActivity.fav_click;
import static com.wily.utils.ATUtils.context;
import static com.wily.utils.ATUtils.utils;
...
//			CircleLayout gridViewt= (CircleLayout) view.findViewById(R.id.items_grid);
            ...
            final Drawable sDraw = mContext.getResources().getDrawable(R.drawable.assistive_add_shortcut);
                            ...
                            case 0:
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        for (int i = 0; i < 7; i++) {
                                            CircleImageView newMenu = new CircleImageView(mContext);
                                            newMenu.setLayoutParams(new ViewGroup.LayoutParams(150, 150));
//										newMenu.setLayoutParams(new ViewGroup.LayoutParams((int)mContext.getResources().getDimension(R.dimen.height),(int)mContext.getResources().getDimension(R.dimen.width)));
                                            newMenu.setBackgroundDrawable(itemAssistive.get(i).getBackground());
