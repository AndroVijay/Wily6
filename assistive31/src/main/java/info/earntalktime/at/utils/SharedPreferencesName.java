...
public class SharedPreferencesName {
	...
	/************* end of MyPref parameters **************/

	/*************
	 * start of Profile parameters
	 **************/
	...
	/*************
	 * start of notificati parameters
	 **************/
	public static String TAG_NOTIFICATION = "notificati";
	public static final String COUNTER_TAG = "newnotification";
	/************* end of notificati parameters **************/

	/*************
	 * start of MyRedeemDetails parameters
	 **************/
	public static String TAG_REDEEM_DETAILS = "MyRedeemDetails";
	public static final String OPERATOR = "operator";
	public static final String AMOUNT = "amount";
	/************* end of MyRedeemDetails parameters **************/

	/*************
	 * start of ETT Utilities parameters
	 **************/
	public static final String TAG_ETT = "ett";
	// public static final String IS_SHOW_UTILITIES = "isShowUtilities";
	...
	/*************
	 * end of ETT Utilities parameters
	 **************/

	/*************
	 * start of ETT Assistive Touch parameters
	 **************/
	public static final String KEY_IS_AT_ACTIVATED = "isATActivated";
//	public static final String KEY_AT_DRAWABLE = "AT_DRAWABLE";
//	public static final String KEY_AT_WINDOW_COLOR = "AT_WINDOW_COLOR";

	/*************
	 * end of Assistive Touch parameters
	 **************/
	...
	// public static final String TAG_SHARED_CONTACTS = "sharedReadContacts11";

	public static final String TAG_EARN_BYTE_SHORTCUT_ADDED = "shortCutAdded";
	public static final String TAG_SHORTCUT_WALK_THROUGH = "shortcutWalkThorugh20";
	public static final String TAG_EARN_TEXT_SHORTCUT_ADDED = "shortCutAddedEarnText";
}
